# =============================================================================
# app/services/pr_parser_service.py
# =============================================================================
import re
...
class PRParserService:
    ...
    def extract_pr_data(webhook_data: PostmarkInboundWebhook) -> PRExtractionResult:
        ...
        Handles both direct GitHub emails and forwarded Gmail messages
        """
        try:
    ...
    def _extract_repo_name(subject: str) -> Optional[str]:
        ...
        # Sometimes appears as "[org/repo]" or just "org/repo"
    ...
    def extract_recipient_email(webhook_data: PostmarkInboundWebhook) -> str:
        """Extract the primary recipient email"""
        # Try ToFull first
        if webhook_data.ToFull and len(webhook_data.ToFull) > 0:
            return webhook_data.ToFull[0].Email
        
        # Fallback to OriginalRecipient
